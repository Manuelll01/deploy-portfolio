...
import "./Apartament2CamerePopup.css"

export const Apartament2CamerePopup = () => {
    return(
        ...
        <div className="caseta-informatii-si-poza-apartament">
            ...
            <div className="poza-apartament-popup"><img className="img-popup2" src="img/schita_apartament_2camere.jpg"></img></div>
        </div>
