...
import "./Apartament3CamerePopup.css"

export const Apartament3CamerePopup = () => {
    return(
        ...
        <div className="caseta-informatii-si-poza-apartament">
            ...
            <div className="poza-apartament-popup"><img className="img-popup3" src="img/schita_apartament_3camere.jpg"></img></div>
        </div>
        ...
        <div className="contact-form-si-alte-informatii-popup">
            ...
            <div className="alte-informatii-plus-nota">
                <div className="alte-informatii">
                    ...
                    <div className="celula"><p>23,94 m²</p></div>
                    <div className="celula"><p>Dormitor</p></div>
                    <div className="celula"><p>24,64 m²</p></div>
                    <div className="celula"><p>Baie</p></div>
                    <div className="celula"><p>7,04 m²</p></div>
                    <div className="celula"><p>Terasa</p></div>
                    <div className="celula"><p>	15,09 m²</p></div>
                </div>
