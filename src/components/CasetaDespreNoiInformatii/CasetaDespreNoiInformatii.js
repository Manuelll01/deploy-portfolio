...
import "./CasetaDespreNoiInformatii.css"


export const CasetaDespreNoiInformatii = () => {
    return(
        <div className="container-grid-despre-noi">
                    ...
                    <div className="element-2">
                        ...
                        <div className="caseta-2">
                            <h4>8</h4>
                            <h5>blocuri</h5>
                        </div>
                        <div className="caseta-3">
                            <h4>16</h4>
                            <h5>scări</h5>
                        </div>
                        <div className="caseta-4">
                            <h4>195</h4>
                            <h5>locuri de parcare</h5>
                        </div>
                        <div className="caseta-5">
                            <h4>1800mp</h4>
                            <h5>spatii comerciale</h5>
                        </div>
                        <div className="caseta-6">
                            <h4>72</h4>
                            <h5>boxe</h5>
                        </div>
                    </div>
