        ...
        <div className="despre-noi-container">
            <div className="continut-despre-noi">
                ...
                <div className="container-mare-CasetaScris-DespreNoi"><div className={elementVizibil2 ? 'container-mic-CasetaScris-DespreNoi vizibil3' : 'container-mic-CasetaScris-DespreNoi'} ref={myRef2}><CasetaScris
                                                                        titlu="Locatie si bla bla ramane de modificat"
                                                                        continut={<div><p>Complexul imobiliar GREEN PARK Residence se află în sectorul 6, cartierul Militari, București și este situat la doar 5 minute de bulevardul Iuliu Maniu, foarte aproape de Militari Shoping Center.</p>
